    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            List<Product> products = new List<Product>()
            {
                ...
                new Product() { Id = 8, Name = "Printer", Price = 300.0, Category = c3 },
            ...
            var r1 =
                from p in products
                where p.Category.Id == 1 && p.Price <= 900.0
                select p;
            ...
            var r2 =
                ...
                select p.Name;
            Print("NAMES OF PRODUCTOS FROM TOOLS", r2);
